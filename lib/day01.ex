defmodule Day01 do
  ...
  """
  def fuel_requirements_2 do
    get_modules()
    |> Enum.reduce(0, fn mass, fuel ->
      fuel + fuel_req(mass, 0)
    end)
  end

  defp fuel_req(mass, total) do
    fuel = div(mass, 3) - 2

    if fuel <= 0 do
      total
    else
      fuel_req(fuel, fuel + total)
    end
  end

  # common functions

  defp get_modules(input \\ "inputs/day01_input.txt") do
    File.read!(input)
    |> String.split("\n", trim: true)
