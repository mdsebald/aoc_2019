defmodule Day05 do
  ...
  a diagnostic program (your puzzle input).
  ...
  its value is the value stored at address 4 (33). The second parameter, 3 in immediate mode,
  ...
  the ID of the system to test by running an input instruction - provide it 1,
  ...
  For each test, it will run an output instruction indicating
